	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_gfPost() {
                ...
                //戴先生 2017/06/22 訂約日要往前推一年 //2018/07/04 改2年
                $('#txtXdate1').mask(r_picd);
                $('#txtXdate1').val(q_cdn(q_date().substr(0, r_lenm)+'/01',-730).substr(0,r_lenm)+'/01');
				...
				for(var i=0;i<$('#q_report').data().info.reportData.length;i++){
					if($('#q_report').data('info').reportData[i].report=='z_ordhp_vu03'){
						t_index=i;
						break;	
					}
				}
				if(t_report!=undefined && t_report=='z_ordhp_vu03'){
