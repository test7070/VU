	...
	<head>
		...
		<script type="text/javascript">
            ...
            function mainPost() {
                ...
                $('#txtColor').change(function(e) {
                    if ($(this).val().length > 0) {
                        t_where = "where=^^ color='" + $(this).val() + "'^^";
                        q_gt('color', t_where, 0, 0, 0, "checkColor_change", r_accy);
                    }
                });
            ...
            function q_gtPost(t_name) {
                switch (t_name) {
                    case 'checkColor_change':
                        var as = _q_appendData("color", "", true);
                        if (as[0] != undefined) {
                            alert('已存在 ' + as[0].color);
                        }
                        break;
            ...
            function btnOk() {
                var t_err = '';
                t_err = q_chkEmpField([['txtColor', q_getMsg('lblColor')]]);

                if (t_err.length > 0) {
                    alert(t_err);
                    return;
                }
                var t_color = trim($('#txtColor').val());
				var t_noa = trim($('#txtNoa').val());
				
                if (q_cur == 1) {
                    t_where = "where=^^ color='" + t_color + "'^^";
			...
			<div class="dview" id="dview" style="float: left;  width:40%;"  >
				<table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
					<tr>
						...
						<td align="center" style="width:50%"><a id='vewColor'> </a></td>
					</tr>
					<tr>
